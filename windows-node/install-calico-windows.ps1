...
Param(
    ...
    # v3.26.4 is replaced by our build tooling.
    [parameter(Mandatory = $false)] $ReleaseBaseURL="https://github.com/projectcalico/calico/releases/download/v3.26.4/",
    [parameter(Mandatory = $false)] $ReleaseFile="calico-windows-v3.26.4.zip",
